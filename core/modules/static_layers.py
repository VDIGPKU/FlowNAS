...
class MBInvertedConvLayer(MyModule):
    ...
    def __init__(self, in_channels, out_channels,
                 kernel_size=3, stride=1, expand_ratio=6, mid_channels=None, act_func='relu6', use_se=False, channels_per_group=1, norm=None):
        ...
        if self.expand_ratio == 1:
            ...
            self.inverted_bottleneck = nn.Sequential(OrderedDict([
                ...
                ('bn', norm_map_func(norm, feature_dim)),
        ...
        self.point_linear = nn.Sequential(OrderedDict([
            ...
            ('bn', norm_map_func(norm, out_channels)),
        ]))
