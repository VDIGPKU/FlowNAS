...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='datasets/Sintel', dstype='clean'):
        ...
        if split == 'test':
            flow_root = osp.join(root, 'test', 'flow')
        ...
        print('loading sintel training set, {} images'.format(len(self.flow_list)))

        # print(len(self.flow_list))
        # print(len(self.image_list))
        # print(len(self.extra_info))
        # index = np.arange(len(self.flow_list))
        # np.random.shuffle(index)
        # train_len = int(len(self.flow_list)*0.8)
        # train_index = index[:train_len]
        # val_index = index[train_len:]
        # np.savetxt('sintel_val.txt', val_index, fmt='%d')
        # np.savetxt('sintel_train.txt', train_index, fmt='%d')
    ...
    def __init__(self, aug_params=None, split='training', root='datasets/Sintel', dstype='clean', flownet_split=False):
        ...
        if split == 'validation':
            ...
            if flownet_split:
                ...
                index = [i for i in range(len(self.flow_list)) if sintel_split[i] == 2]
                print('using FlowNet split')
            else:
            ...
            if flownet_split:
                sintel_split = np.loadtxt('sintel_split.txt', dtype=np.int32)
                index = [i for i in range(len(self.flow_list)) if sintel_split[i] == 1]
                print('using FlowNet split')
            else:
                index = [i for i in range(len(self.flow_list)) if i%5 != 0]
        ...
        self.extra_info = [self.extra_info[i] for i in index]
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='datasets/KITTI'):
        ...
        if split != 'testing':
            ...
            print('loading kitti training set, {} images'.format(len(self.flow_list)))
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root='datasets/HD1k'):
        ...
        while 1:
            ...
            seq_ix += 1
        print('loading HD1K, {} images'.format(len(self.flow_list)))
